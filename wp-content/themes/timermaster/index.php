        ...
        <div class="row">
            <div class="col-md-8">
                ...
                ?>
                        ...
                        <a href="<?php echo esc_url( the_permalink()); ?>"><?php the_post_thumbnail('Thumbnail',array('class' => 'img-responsive'));?>
                    </a>
                    </div>
                    <div class="blog-content">
                        ...
                        <?php the_excerpt();?>
                        <a href="<?php echo esc_url( the_permalink()); ?>" class="btn btn-dafault btn-details">Continue Reading</a>
                    </div>
                ...
                <div class="sidebar">
                    <div class="search widget">
                        ...
                        <div class="author widget">
                            <img class="img-responsive" src="<?php echo get_template_directory_uri() ?> /images/author/author-bg.jpg">
                            <div class="author-body text-center">
                                <div class="author-img">
                                    <img src="<?php echo get_template_directory_uri() ?> /images/author/author.jpg">
                                </div>
