    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 wow fadeInLeft" data-wow-delay=".3s" >
                <img src="<?php echo get_template_directory_uri(); ?>/images/about/about-company.jpg" alt="" class="img-responsive">
            </div>
            <div class="col-md-6">
                <div class="block">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".3s">
                    <div class="team-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/team/team-1.jpg" class="team-pic" alt="">
                    </div>
            ...
            <div class="col-md-3">
                <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".5s">
                    <div class="team-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/team/team-2.jpg" class="team-pic" alt="">
                    </div>
            ...
            <div class="col-md-3">
                <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".7s">
                    <div class="team-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/team/team-3.jpg" class="team-pic" alt="">
                    </div>
            ...
            <div class="col-md-3">
                <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".9s">
                    <div class="team-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/team/team-4.jpg" class="team-pic" alt="">
                    </div>
