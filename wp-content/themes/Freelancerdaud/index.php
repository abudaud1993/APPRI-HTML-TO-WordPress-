          ...
          <div class="container">
            <div class="row">
              <div class="col-xl-3 col-lg-3 col-md-2 col-sm-2 col-sx-12">
                ...
                <div class="site_logo">
                  <a href="#"> <img src="<?php echo get_template_directory_uri();?>/assets/images/logo/freelancerdaud-4.svg" width="170px" height="70px"
                      alt="Logo" /></a>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-sx-12">
              <div class="author_image">
                <a href="">
                  <img class="img" src="<?php echo get_template_directory_uri();?>/assets/images/author/Freelanceerdaud.jpg" alt="">
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-sx-12">
              ...
              <div class="author_text_area mb-20 ">
                <h1> FREELANCER <span class="dc"> DAUD </span> </h1>
                <h2>I AM A </h2>
              ...
              <div class="social-icons ">
                <ul class="">
                  ...
                  <li class=""><a href="#"><span class="icone_style"> <i class="fab fa-twitter"></i> </span> </br><span
                        class="icone_style1">Tweet</span></a></li>
                  <li class=""><a href="#"><span class="icone_style"> <i class="fab fa-instagram"></i> </span> </br>
                      <span class="icone_style1">Instagram</span></a></li>
                  <li class=""><a href="#"><span class="icone_style" class="icone_style"> <i
                          class="fab fa-youtube-square"></i> </span> </br> <span class="icone_style1">YouTube</span></a>
                  </li>
    ...
    <main>
          ...
          <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-sx-12">
              ...
              <div class="about_content mb-20">
                <p>I'm a Full Stack Web Developer mainly & I have good experience on Graphics Design too. I'm currently
                  performing as a Public Figure & Motivational Speaker on My Youtube Channel. I have been working as a
                  Web Developer over the last 7 years. I used to work on Freelancer.com & Now I'm in a partnership
                  business with some of my clients. On the other side. I was the Chife Operating Officer of an Affiliate
                  Network called CPAWORKER.COM

                  Moreover I used to work with different companies as a Customer Support manager, I handled inbound
                  calls daily. Recently I am trying to work for the young generation as an Entrepreneur</p>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-sx-12">
              <div class="work_img">
                <img class="img" src="<?php echo get_template_directory_uri();?>/computer-work.jpg" alt="">
          ...
          <div class="row">
            ...
            <div class="skill_bar_all">
              <div class="skill_bar_title mb-20">
                <h3> My Skills</h3>
                <p>Have More Than 4 Years Of Experience</p>
                <hr>
      ...
      <section id="service" class="service_area ">
        <div class="container">
          <div class="service mb-60">
            <h1>SERVICE</h1>
            <p>Some of my main services are listed below. I provide different kind of services.</p>
          </div>
      ...
      <section class="portfolio_area">
        <div class="portfolio_title_subtitle mb-60">
          <!-- <h1>PORTFOLIO'S</h1> -->
          <h1>Latest Works</h1>
          <p>"Client’s satisfaction is my first priority"</p>
        </div>
        <div class="container">
      ...
      <!-- Review Section End -->
      <div id="contract" class="mb-170"></div>
