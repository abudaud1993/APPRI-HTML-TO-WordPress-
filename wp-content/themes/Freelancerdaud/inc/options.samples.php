...
//
// Field: Header & Logo Section
//
CSF::createSection( $prefix, array(
  'parent'      => 'general_fields',
  'title'       => 'Header & Logo Section',
  'icon'        => 'fa fa-eye',
  'description' => 'Hear General Start',
  'fields'      => array(
      ...
      'subtitle' =>'.PNG , .JPG ',
      'after' =>  'Upload your logo Image.',
      'default'  => array(
        'url'  => get_template_directory_uri() . '/assets/images/logo/freelancerdaud-4.svg',
      ),
    ...
    array(
      ...
      'subtitle' =>'Site Title ',
      'after' =>  ' Inpute Your Site Title.',
      'default'  => 'FREELANCER DAUD'
    ...
    array(
      ...
      'after' =>  ' Inpute Your Site Tagline.',
    ...
    array(
      'id'      => 'site_icon',
      'type'    => 'media',
      'title'   => 'Site Icon Image',
      'subtitle' =>'.PNG , .JPG, ext ',
      'after' =>  'Upload your Site Icon Image.',
      'default'  => array(
        'url'  => get_template_directory_uri() . '/assets/images/logo/freelancerdaud-4.svg',
      ),
    ),
...
//
// Field: slider & author Section
//
CSF::createSection( $prefix, array(
  'parent'      => 'home_fields',
  'title'       => 'Slider section',
  'icon'        => 'fa fa-sliders',
  'description' => 'Hear Slider Section Start',
  'fields'      => array(
    ...
    array(
      ...
      'title'   => 'Admin Image',
      'subtitle' =>'.PNG , .JPG, ext ',
      'after' =>  'Upload your Admin Image.',
      'default'  => array(
        'url'  => get_template_directory_uri() . '/assets/images/author/Freelanceerdaud.jpg',
      ),
    ),
    ...
    array(
      ...
      'after' =>  ' Inpute Your Slider Title.',
      'default'  => 'FREELANCER'

    ),
    array(
      'id'      => 'slidder_daud_title',
      'type'    => 'text',
      'title'   => 'Slider Daud Title',
      'subtitle' =>'Slider Daud Title ',
      'after' =>  ' Inpute Your Slider Daud Title.',
      'default'  => ' DAUD '
    ...
    array(
      ...
      'after' =>  ' Inpute Your Slider SubTitle.',
      'default'  => 'I AM A '
    ...
    // ),
        ...
        array(
          ...
          'type'    => 'icon',
          'title'   => 'Icon',
          'subtitle' =>'Social Icon ',
          'after' =>  ' Add FaceBook Icon.',
...
CSF::createSection( $prefix, array(
  ...
  'description' => 'Hear About Section Start',
  'fields'      => array(
    ...
    array(
      ...
      'after' =>  ' Inpute Your About SubTitle.',
    ...
    array(
      ...
      'subtitle' =>'About Text Title ',
      'after' =>  ' Inpute Your About Text Title.',
      'default'  => 'A Piece Of Information...',
    ),

    array(
      'id'      => 'about_text_subtitle',
      'type'    => 'textarea',
      'title'   => 'About Text SubTitle',
      'subtitle' =>'About Text SubTitle ',
      'after' =>  ' Inpute Your About Text SubTitle.',
      'default'  => "I'm a Full Stack Web Developer mainly & I have good experience on Graphics Design too. I'm currently performing as a Public Figure & Motivational Speaker on My Youtube Channel. I have been working as a Web Developer over the last 7 years. I used to work on Freelancer.com & Now I'm in a partnership business with some of my clients. On the other side. I was the Chife Operating Officer of an Affiliate Network called CPAWORKER.COM Moreover I used to work with different companies as a Customer Support manager, I handled inbound calls daily. Recently I am trying to work for the young generation as an Entrepreneur",
    ),
    array(
      'id'      => 'about_img',
      'type'    => 'media',
      'title'   => 'About Image',
      'subtitle' =>'.PNG , .JPG, ext ',
      'after' =>  'Upload Your About Image.',
      'default'  => array(
        'url'  => get_template_directory_uri() . '/computer-work.jpg',
      ),
    ),
  ...
  //
// Field: My skills Section
//
CSF::createSection( $prefix, array(
  'parent'      => 'home_fields',
  'title'       => 'Skills section',
  'icon'        => 'fa fa-book',
  'description' => 'Hear Skills Section Start',
  'fields'      => array(
    ...
    array(
      ...
      'type'    => 'text',
      'title'   => 'Skills Title',
      'subtitle' =>'Skills Title ',
      'after' =>  ' Inpute Your Skills Title.',
      'default'  => 'My Skills'
    ),
    ...
    array(
      ...
      'after' =>  ' Inpute Your Skills SubTitle.',
      'default'  => 'Have More Than 4 Years Of Experience',
    ),
...
CSF::createSection( $prefix, array(
  ...
  'icon'        => 'fa fa-taxi',
  'description' => 'Hear Service Section Start',
  'fields'      => array(
    ...
    array(
      ...
      'after' =>  ' Inpute Your Service Title.',
      'default'  => 'SERVICE'
    ),
    ...
    array(
      ...
      'after' =>  ' Inpute Your Service SubTitle.',
      'default'  => 'Some of my main services are listed below. I provide different kind of services.',
    ),
  ...
  //
// Field: Latest Works Section
//
CSF::createSection( $prefix, array(
  'parent'      => 'home_fields',
  'title'       => 'Latest Works section',
  'icon'        => 'fa fa-briefcase',
  'description' => 'Hear Latest Works Section Start',
  'fields'      => array(
    array(
      'id'      => 'Works_title',
      'type'    => 'text',
      'title'   => 'Works Title',
      'subtitle' =>'Works Title ',
      'after' =>  ' Inpute Your Works Title.',
    ...
    array(
      'id'      => 'Works_subtitle',
      'type'    => 'textarea',
      'title'   => 'Works SubTitle',
      'subtitle' =>'Works SubTitle ',
      'after' =>  ' Inpute Your Works SubTitle.',
      'default'  => '"Client’s satisfaction is my first priority"',
    ),
  )));

  //
// Field: What My Client's Say Section
//
CSF::createSection( $prefix, array(
  'parent'      => 'home_fields',
  'title'       => 'Client Reviwe section',
  'icon'        => 'fa fa-user',
  'description' => 'Hear What My Client"s Say Section Start',
  'fields'      => array(
    array(
      'id'      => 'Reviwe_title',
      'type'    => 'text',
      'title'   => 'Client Reviwe Title',
      'subtitle' =>'Client Reviwe Title ',
      'after' =>  ' Inpute Your Client Reviwe Title.',
      'default'  => 'What My Client"s Say'
    ),
   ...
   //
// Field: CONTACT US Section
//
CSF::createSection( $prefix, array(
  'parent'      => 'home_fields',
  'title'       => 'Contact section',
  'icon'        => 'fa fa-envelope',
  'description' => 'Hear CONTACT US Section Start',
  'fields'      => array(
    array(
      'id'      => 'CONTACT_title',
      'type'    => 'text',
      ...
      'after' =>  ' Inpute Your CONTACT US Title.',
      'default'  => 'CONTACT US'
    ),
    ...
    array(
      ...
      'after' =>  ' Inpute Your CONTACT US SubTitle.',
      'default'  => 'CONTACT for my',
    ),
  )));
